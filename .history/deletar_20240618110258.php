...
try {
    ...
    throw new \Exception('Não foi possível deletar os dados do banco de dados!', 422); 
    ...
    if (!mysqli_query($conn, $sql)) {
        throw new \Exception('Não foi possível deletar os dados do banco de dados!', 422); // 422 conflict statusCode
    } else {
        $statusCode  = 200;
        $response = [
